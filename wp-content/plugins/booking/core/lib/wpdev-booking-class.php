...
class wpdev_booking {
    ...
    function pre_get_calendar_html( $resource_id=1, $cal_count=1, $bk_otions=array() ){
	    ...
	    if ( ( ! class_exists( 'wpdev_bk_personal' ) ) && ( $booking_is_show_powered_by_notice == 'On' ) ) {
		    $calendar .= '<div class="bookingheadtitleme" style="font-size:7px;text-align:left;margin:0 0 10px;text-shadow: none;">Powered by <a href="https://wpbookingcalendar.com" style="font-size:7px;" target="_blank" title="Booking Calendar plugin for WordPress">Booking Calendar</a></div>';
	    }
