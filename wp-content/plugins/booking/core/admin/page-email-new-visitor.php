...
function wpbc__get_replace_shortcodes__email_new_visitor( $booking_id, $bktype, $formdata ) { 
	...
	$replace['add_to_google_cal_button'] = '<a class="googlecalendermeinme" href="' . esc_attr( $replace['add_to_google_cal_url'] ) . '" target="_blank" rel="nofollow">' . esc_attr__( 'Add to Google Calendar', 'booking' ) . '</a>';
